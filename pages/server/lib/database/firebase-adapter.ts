...
// export interface AdapterExtension extends Adapter {
//     requestVerification?: (params: {
//         requester: string;
//         verified: boolean;
//     }) => Awaitable<VerificationResult | null>
...
// export function FirestoreExtension(client:FirebaseClient) : AdapterExtension {
// 	const { db } = client;
...
// export function requestVerification extends Adapter {}

// export interface requestVerification extends FirebaseClient {}

// export interface FirestoreExtension

// declare function requestVerification(params: {
//             requester: string;
//             verified: boolean;
