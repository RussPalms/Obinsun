...
//         {/* <div className="grow min-h-full min-w-full relative"> */}
//         <div className="grow min-h-screen min-w-full relative top-0 left-0 z-40">
//           <div className="relative top-0 left-0 z-50"></div>
//           {/* Top Left */}
...
//           </section>
//         </div>
//         <div className="hidden flex h-full w-full absolute top-0 left-0 z-40">
//           {/* Content */}
//           <section className="flex-1 relative top-0 left-0 opacity-100 z-40 flex justify-center align-center w-full h-full">
//             <div className="grow absolute left-0 blur-[0em] top-[0%] max-w-[80%] min-h-[80%] bg-blue-900 z-40">
//               <p className="">
...
export default function blurTest2() {}
