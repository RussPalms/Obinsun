...
function LayoutTest({}: Props) {
  return (
    <>
      ...
      {/* <div className="bg-gray-700 absolute top-0 h-[200%] w-[200%] blur-[1em] border border-gray-400 rounded-3xl z-40 "></div> */}
      <div className="transition-all duration-500 bg-gradient-to-tl from-red-300 via-fuchsia-200 to-blue-900 dark:text-blue-300 text-red-900 bg-size-200 bg-pos-100 dark:bg-pos-0 relative">
        <div className="grid grid-rows-layout">
          {/* <div className="bg-gray-400 relative top-[50%] left-[50%] h-[80%] w-[90%] blur-[1em] border border-gray-400 rounded-3xl"></div> */}
