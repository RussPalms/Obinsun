...
function Authentication({ csrfToken, userData }) {
  ...
  return (
    ...
    <section className="top-[50%] flex justify-center align-center bg-gradient-to-b from-[#f1f4f9] to-[#dff1ff]">
      {/* <div className="color dark:bg-indigo-600" />
      <div className="color bottom-[-150px] left-[100px] w-[500px] h-[500px] bg-[#fffd87] dark:bg-yellow-900" />
      <div className="color bottom-[50px] right-[100px] w-[300px] h-[300px] bg-[#00d2ff] dark:bg-blue-600" /> */}
