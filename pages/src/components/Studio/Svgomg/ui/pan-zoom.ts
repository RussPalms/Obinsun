...
//   function touchDistance(touch1:any, touch2:any) {
...
//       // unbound
//       eventArea.addEventListener('wheel', (event:any) => this._onWheel(event);
//     }
